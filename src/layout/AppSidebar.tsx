...
const navItems: NavItem[] = [
  {
    icon: <GridIcon />,
    name: "Dashboard",
    subItems: [{ name: "Scenario Modeling", path: "/", pro: false }],
  },
  {
    icon: <UserCircleIcon />,
    name: "User Profile",
...
const othersItems: NavItem[] = [
  {
    ...
    subItems: [
      ...
      { name: "Tables", path: "/components/tables" },
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Forgot Password", path: "/pages/forgot-password" },
      { name: "Reset Password", path: "/pages/reset-password" },
      { name: "404 Not Found", path: "/pages/404-not-found" },
    ],
  },
  {
    icon: <CalenderIcon />,
